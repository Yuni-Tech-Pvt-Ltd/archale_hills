...
export default function BlogSection() {
  ...
  return (
    <section className="w-full py-24 bg-gray-50 mt-60">
            ...
            {blogs.slice(1).map((blog, index) => (
              ...
              >
                ...
                <div className="p-6 bg-white">
                  ...
                  <button className="px-4 py-2 bg-[#FFD700] text-[#1B2A49] font-semibold rounded-full hover:bg-yellow-500 transition">
                    Read More
                  </button>
                </div>
              </div>
