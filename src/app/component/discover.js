...
export default function Discover() {
  return (
    <section
      id="about"
      className="w-full py-20 px-6 md:px-20 bg-white flex justify-center"
    >
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center relative">
        <div className="bg-[#f3f5f9] shadow-lg  p-10 md:w-1/2 z-10 md:mr-[-80px]">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            From the grandness of the Great Room to the customised tranquillity
            of each suite, there's something for everyone.
          </p>
